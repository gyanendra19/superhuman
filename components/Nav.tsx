  ...
  return (
    <div className="flex bg-black w-full items-center md:px-6 px-2 justify-between">
        ...
        {openMenu && (
          ...
          className="absolute top-20 overflow-hidden left-0 w-full bg-black p-8 h-full z-20"
      >
          <div className="phone-gradient -left-100 -top-30 absolute inset-0 w-[1700px] h-[1200px]"></div>
